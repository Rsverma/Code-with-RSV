document.addEventListener("DOMContentLoaded", function () {
  ...
  MyFunction(document.getElementsByClassName("vMenu--active")[0]);
}),
  (function (e) {
...
function MyFunction(el) {
  var elements = document.getElementsByClassName("vMenu--item");
  for (var i = 0; i < elements.length; i++) {
    elements.item(i).classList.remove("vMenu--active");
  }
  var mainAreas = document.getElementsByClassName("page__main__box");
  for (var i = 0; i < mainAreas.length; i++) {
    if (!mainAreas.item(i).classList.contains("hide"))
      mainAreas.item(i).classList.add("hide");
  }
  el.classList.add("vMenu--active");
  document.getElementById(el.textContent).classList.remove("hide");
}
